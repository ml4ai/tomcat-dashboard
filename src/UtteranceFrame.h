...
class UtteranceFrame : public wxFrame
{
	...
	public:
		...
		UtteranceFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 1172,878 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
